...
cran_checks <- function(pkg) {
  ...
  paste0(
    color_note, n_notes, if (n_notes > 1) " Notes</span><br>" else " Note</span><br>",
    color_warning, n_warnings, if (n_warnings > 1) " Warnings</span><br>" else " Warning</span><br>",
    color_error, n_errors, if (n_errors > 1) " Errors</span><br>" else " Error</span><br>",
